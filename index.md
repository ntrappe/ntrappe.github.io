...
###### This page will provide all the tools and tricks for fellow CSE undergraduates to excel in coding interviews. It includes: [Data Structures](https://github.com/ntrappe/ntrappe.github.io/blob/main/index.md#data-structures), [Programming Languages](#Programming-Languages), [Sorting Algorithms](#Sorting-Algorithms), [Preparation](#How-to-Prepare), & [Common Questions](#Common-Questions). Designed by: [ntrappe](https://github.com/ntrappe) ###### 
